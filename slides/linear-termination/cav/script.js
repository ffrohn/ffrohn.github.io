...
states.push(new State("ex").set_fadein(["ex", "ex-no-matrix"]).set_scale(1.1));
...
states.push(new State("prog").set_fadeout(["ex", "non-linear-1"]).set_delay(3000).set_scale(1.1));
...
states.push(new State("growth").set_fadein(["growth4"]).set_scale(1.1));
...
states.push(new State("svg").set_scale(1.1).set_fadeout(["ex"]).set_delay(3000));
